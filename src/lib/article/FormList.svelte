<script lang="ts">
  ...
  import { Button, Textarea } from "$lib/material";
  import { createMutation, useQueryClient } from "@tanstack/svelte-query";
  import { faCircleNotch } from "@fortawesome/free-solid-svg-icons";

  import IconLink from "$lib/util/IconLink.svelte";
  import type { Article, ArticleCreate, ISubscribe } from "$lib/types";
  ...
  const createArticles = createMutation({
    mutationFn: (articles: ArticleCreate[]) =>
