<script lang="ts">
  ...
  import { Textarea, TextField, Icon, List, ListItem } from "$lib/material";
  import L from "leaflet";
  import debounce from "debounce";

  import markerIcon from "$lib/assets/images/marker-icon.png";
  import markerIcon2X from "$lib/assets/images/marker-icon-2x.png";
