  ...
  {#if show}
    <svg viewBox="0 0 200 200" in:rotate={{ delay: 0, duration: 2800 }}>
      {#if showPathsCenter}
        ...
        />
        <path
          d="M50,186.6 L150,186.6 L200,100"
          fill="white"
          stroke="rgb(100, 100, 100)"
          in:draw={{ duration: 1000, easing: quadInOut }}
          out:fade|local
      ...
      {#if showPolygonsInt}
        <polygon
          points="100,100 0,100 50,186.6 150,186.6 "
          fill="rgb(240, 2j40, 240)"
          out:fly|local={{
            x: -12.5,
            y: 21.65,
            duration: 800,
        ...
        />
        <polygon
          points="100,100 150,13.4 200,100 150,186.6"
          fill="rgb(216, 216, 216)"
          out:fly|local={{ x: 25, y: 0, duration: 800, easing: quadInOut }}
        />
        <polygon
          points="100,100 150,13.4 50,13.4 0,100"
        ...
        <polygon
          points="100,100 200,100 150,13.4 50,13.4"
          fill="white"
          out:fly|local={{
            x: 25,
            y: -43.3,
        ...
        />
        <polygon
          points="100,100 50,13.4 0,100 50,186.6"
          fill="white"
          out:fly|local={{
            x: -50,
            y: 0,
        ...
        />
        <polygon
          points="100,100 50,186.6 150,186.6 200,100"
          fill="white"
          out:fly|local={{
            x: 25,
            y: 43.3,
      ...
      {#if showPolygons}
        <polygon
          ...
          in:fade
          out:fly|local={{ x: 25, y: -43.3, duration: 1000, easing: quadInOut }}
        />
        <polygon
          points="100,100 50,13.4 0,100 50,186.6"
          fill="rgb(216, 216, 216)"
          in:fade
          out:fly|local={{ x: -50, y: 0, duration: 1000, easing: quadInOut }}
        />
        <polygon
          points="100,100 50,186.6 150,186.6 200,100"
          fill="rgb(168, 168, 168)"
