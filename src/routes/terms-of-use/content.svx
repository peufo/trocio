...
L’ensemble des fonctionnalités peut évoluer au gré des remarques et du développement de la Plateforme.
...
Le devoir de l’Organisateur est de faire en sorte que les enregistrements effectués sur l'application, que ce soit changement de status d'article ou paiement, correspondent le plus fidèlement à la réalité. Ayant un grand contrôle sur les données liées à son événement, l’Organisateur est le seul à répondre de leurs qualités et de leurs justesse.
...
Trocio n’est pas responsable du contenu inadéquat que l’organisateur a publié sur Trocio. Par la mise en ligne de contenu mensonger, frauduleux, seul l’Organisateur répond du dommage qu’il a causé aux Participants / Utilisateurs.
